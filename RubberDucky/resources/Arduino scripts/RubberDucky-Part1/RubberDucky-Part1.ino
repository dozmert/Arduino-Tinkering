/*
.DESCRIPTION
  This script allows the user to execute scripts loaded onto a MicroSD card module connected to the Arduino. When the Arduino is plugged in via USB, the script on the memory card is executed.
