/*
.DESCRIPTION
  This script allows the user to load multiple scripts onto a MicroSD card module connected to the Arduino. Using a DIP switch combination, the user can select what script to execute when the Arduino is plugged in via USB.
